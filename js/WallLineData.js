function WallLineData()
{
		...
		this.OnInit = function( x1,y1,z1,fWidth )
		{
			...
			var geom = new THREE.Geometry();
				...
				geom.vertices.push(new THREE.Vector3( 0.5, 0, 0));
			this.mLine = new THREE.LineSegments( geom, new THREE.LineBasicMaterial( { color: '#363636', linewidth: 6,} ) );
		...
		this.OnUpdate3D = function()
		{
			...
			this.mWallData3D_In.mTextureData.mMaterial = new THREE.MeshStandardMaterial( {color: new THREE.Color(color)} );	
			...
			this.mWallData3D_In.m_vStart = this.m_vStart;
			this.mWallData3D_In.m_vEnd   = this.m_vEnd;			
